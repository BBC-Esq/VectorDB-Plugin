...
VECTOR_MODELS = {
    ...
    'Octen': [
        ...
        {
            'name': 'Octen-Embedding-4B-INT8',
            'dimensions': 2560,
            'max_sequence': 8192,
            'size_mb': 4410,
            'repo_id': 'Octen/Octen-Embedding-4B-INT8',
            'cache_dir': 'Octen--Octen-Embedding-4B-INT8',
            'type': 'vector',
            'parameters': '4020m',
            'precision': 'int8',
            'rank': 2,
        ...
        {
            'name': 'Octen-Embedding-8B-INT8',
            'dimensions': 4096,
            'max_sequence': 8192,
            'size_mb': 8190,
            'repo_id': 'Octen/Octen-Embedding-8B-INT8',
            'cache_dir': 'Octen--Octen-Embedding-8B-INT8',
            'type': 'vector',
            'parameters': '7570m',
            'precision': 'int8',
            'rank': 1,
